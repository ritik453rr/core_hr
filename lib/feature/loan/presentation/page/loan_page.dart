          ...
          children: [
            ...
            Container(
              ...
              child: const Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Company Loan Eligibility', style: TextStyle(color: Color(0xFF94A3B8), fontSize: 12)),
                  SizedBox(height: 6),
                  Text('\$15,000 / ₹300,000', style: TextStyle(color: Colors.white, fontSize: 24, fontWeight: FontWeight.bold)),
                  SizedBox(height: 12),
                  Row(
