      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Expanded(child: Obx(() => _balanceCard('Casual Leave', '${controller.casualLeaveBalance.value}', 'Days Left', const Color(0xFF3B82F6)))),
                const SizedBox(width: 8),
                Expanded(child: Obx(() => _balanceCard('Sick Leave', '${controller.sickLeaveBalance.value}', 'Days Left', const Color(0xFFEC4899)))),
                const SizedBox(width: 8),
                Expanded(child: Obx(() => _balanceCard('Earned Leave', '${controller.earnedLeaveBalance.value}', 'Days Left', const Color(0xFF10B981)))),
              ],
            ),
